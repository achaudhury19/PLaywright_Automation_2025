...
//initialize page veariable for browswer
let page: Page
let string: string // just an example
...
test('Search for a keywaor on bing @smoke', async () => {
//navigate to bing
...
//for concatenation purpose, you eaither can use comma, or +
